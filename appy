...
st.write("El juego combina dos mundos: el físico y el digital. En cada fase del viaje:")
...
st.sidebar.link_button("Invítame un café ☕", "https.coff.ee/regifreyman8") # Reemplaza con tu enlace correcto
